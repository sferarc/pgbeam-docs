...
[audit history](/docs/audit-log): the exact tables it touched, the statement
...
[Right-size from traffic](/docs/policies#test-a-policy-before-you-roll-it-out).

```bash title="Recommend a least-privilege policy for a credential"
...
The same operation is available in the **Credentials** tab (the rotate action on
