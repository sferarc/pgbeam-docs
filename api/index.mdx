...
The public spec is available at [api.pgbeam.com/openapi.json](https://api.pgbeam.com/openapi.json). It is the source for our SDK and the generated endpoint pages in this section.
...
Feed the spec to your OpenAPI tooling of choice. For example, with [openapi-generator](https://openapi-generator.tech/):
