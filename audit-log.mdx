...
It covers agent and human credentials, and records each credential's `principal_type` so you can tell agent traffic from people. To stream events to your own systems in real time, see [audit export](/docs/audit-export); to flag unusual behavior automatically, see [anomaly detection](/docs/anomaly-detection).
