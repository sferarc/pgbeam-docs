...
description:
  ...
  spend limits as Kubernetes custom resources using the Crossplane provider.
---
...
Crossplane creates the PgBeam project and its primary database atomically. The
...
**Status:** `proxyHost`, `queriesPerSecond`, `burstSize`, `maxConnections`,
...
**Status:** `verified`, `verifiedAt`, `tlsCertExpiry`, `dnsVerificationToken`,
...
**Status:** `queryHash`, `normalizedSQL`, `queryType`, `callCount`,
...
**Status:** `orgID`, `plan`, `billingProvider`, `subscriptionStatus`,
