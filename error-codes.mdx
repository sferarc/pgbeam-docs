...
**Cause:** The project has an [IP allowlist](/docs/ip-allowlist) configured and the client's source IP does not match any of the allowed CIDR ranges. The connection is rejected before authentication.
