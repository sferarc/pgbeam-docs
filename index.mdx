...
<Card title="Hosted MCP" href="/docs/mcp" icon="🔌">
  Paste one URL into Claude Code, Cursor, or any MCP client. Eight tools:
  policy-enforced query, validate_sql, list_tables, describe_table, explain, and
  schema_catalog, plus search_docs and read_doc.
</Card>
