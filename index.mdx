...
enforces what it can do: read-only access, table and column allowlists, PII
...
<Card title="Hosted MCP" href="/docs/mcp" icon="🔌">
  Paste one URL into Claude Code, Cursor, or any MCP client. Policy-enforced
  query, list_tables, describe_table, and explain tools.
</Card>
