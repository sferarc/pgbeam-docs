...
<Tabs items={["Plain JDBC", "HikariCP", "Spring Boot"]}>
  <Tab value="Plain JDBC">
    ...
    String url = "jdbc:postgresql://abc.proxy.pgbeam.app:5432/mydb";
    String user = "user";
  ...
  <Tab value="HikariCP">
    ...
    config.setJdbcUrl("jdbc:postgresql://abc.proxy.pgbeam.app:5432/mydb");
  ...
  <Tab value="Spring Boot">
    ...
    spring.datasource.url=jdbc:postgresql://abc.proxy.pgbeam.app:5432/mydb
...
```
jdbc:postgresql://abc.proxy.pgbeam.app:5432/mydb?ssl=true&sslmode=require
```

For Spring Boot:

```properties title="application.properties"
spring.datasource.url=jdbc:postgresql://abc.proxy.pgbeam.app:5432/mydb?ssl=true&sslmode=require
```
...
[Cache Rules](/docs/cache) in the dashboard, with no code changes needed.
...
// Server returns NOTICE: pgbeam:cache hit age=12s ttl=1m0s swr=30s
```
