...
For JPA/Hibernate queries and Spring Data repositories, PgBeam automatically tracks the generated SQL shapes. Enable caching for specific shapes through [Cache Rules](/docs/cache) in the dashboard, with no code changes needed.
