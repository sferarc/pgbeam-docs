...
A prebuilt binary distribution is planned but not available yet. If you are on
the hosted platform without source access, the
[policy what-if and replay](/docs/policies#test-a-policy-before-you-roll-it-out)
endpoints cover the same test-before-rollout need against your real traffic, no
