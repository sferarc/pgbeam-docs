...
Each plan includes a fixed number of team seats.
...
<Callout type="info">
  Inviting a member past the included seat count is blocked until you remove a
  member or move to a plan with more included seats. To raise a seat count
  beyond what a plan includes, contact
  [sales@pgbeam.com](mailto:sales@pgbeam.com) about an Enterprise plan.
</Callout>
