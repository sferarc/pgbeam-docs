...
For standard queries, PgBeam tracks the SQL shapes flowing through your
project. Enable caching for specific shapes through [Cache Rules](/docs/cache)
...
This applies to all migration tools — [golang-migrate](https://github.com/golang-migrate/migrate),
