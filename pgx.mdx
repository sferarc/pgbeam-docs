...
For standard queries, PgBeam tracks the SQL shapes flowing through your project. Enable caching for specific shapes through [Cache Rules](/docs/cache) in the dashboard. No code changes needed.
...
This applies to all migration tools: [golang-migrate](https://github.com/golang-migrate/migrate), [goose](https://github.com/pressly/goose), [atlas](https://atlasgo.io/), or custom migration scripts.
