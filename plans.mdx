...
icon: CreditCard
description: Plan tiers, feature comparison, per-plan quotas, overage billing, rate limits, and default settings.
---
...
Team seats are not metered overage: each plan includes a fixed number of seats (1 / 3 / 5 for Starter / Pro / Scale), and inviting past that count is blocked until you remove a member or move to a plan with more included seats. To raise a seat count beyond what a plan includes, contact [sales@pgbeam.com](mailto:sales@pgbeam.com) about an Enterprise plan.
...
| Setting | Default | Description |
| --- | --- | --- |
| Pool mode | Transaction | Upstream connection held only for the duration of a transaction |
| SSL mode | `verify-full` | Full TLS verification for upstream |

## Enterprise

For organizations with requirements beyond the Scale plan (custom quotas, SLAs, dedicated support, or volume pricing), contact [sales@pgbeam.com](mailto:sales@pgbeam.com).
