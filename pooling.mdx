...
icon: Waves
description: How PgBeam pools upstream PostgreSQL connections per project, keyed by user credentials, and how to choose the right pool mode for your workload.
---
...
Pool modes control how upstream connections are shared between clients. New databases default to **transaction mode**, the best balance of connection reuse and compatibility for most web and serverless workloads. You configure the mode per-project from the dashboard, API, or CLI.
