...
<Callout
  type="warn"
  title="These numbers come from a 42-value corpus, not from production traffic"
>
  The detector is tested against a corpus of 13 hostile and 29 benign values
  that lives in the source tree, and the figures below are that test's printed
  output. They describe how the detector behaves on those 42 values. They are
...
| --- | --- | --- | --- |
| Structural only | 61.5% (8/13) | 100.0% (8/8) | 0.0% (0/29) |
| Both layers | 92.3% (12/13) | 92.3% (12/13) | 3.4% (1/29) |
