...
For ORM queries (SQLAlchemy, Django ORM), PgBeam tracks the SQL shapes automatically. Enable caching for specific shapes through [Cache Rules](/docs/cache) in the dashboard.
