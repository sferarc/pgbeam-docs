...
package provides native Pulumi resources for projects, databases, replicas, custom domains, cache rules, spend limits, agent credentials, policy profiles, webhook endpoints, self host enrollments, and honeytokens.
...
```ts
const res = new pgbeam.Honeytoken("example", {
  projectId: "prj_01j9x8y7z6w5v4u3t2s1r0q9p8",
  schemaName: "public",
