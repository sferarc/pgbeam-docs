...
title: Resilience
icon: ShieldCheck
description: How PgBeam keeps database connections reliable with circuit breakers, scale-to-zero, health checks, fail-open caching, and upstream TLS.
---
...
Your application should treat this as a transient failure and retry with backoff. See [Error Codes](/docs/error-codes) for handling guidance.
