...
PgBeam strips annotations before forwarding. See [Read Replicas](/docs/replicas) for setup instructions, ORM examples, and health check details.
...
See [Resilience](/docs/resilience) for detailed circuit breaker behavior and recovery.
