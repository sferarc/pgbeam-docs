...
Once SSO is configured and tested, you can **enforce** it for your organization.
Enforcement means:
...
**Require SSO for all members**. Confirm the action — all non-owner members will
...
- [Organizations](/docs/organizations) — Roles, team seats, and member
  management
