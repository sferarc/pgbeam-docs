...
```typescript
const result = await api.crm.listCrmResearchTasks({
...
`Promise<ListResearchTasksResponse>`: list of research tasks.
...
const result = await client.api.crm.listCrmResearchTasks({
  pathParams: { org_id: "org_abc123" },
